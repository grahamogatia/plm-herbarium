				...
				const nextValues: FormValues = {
					...
					collector_names:
						collectors.length > 0
							...
							: [""],
					date_collected: specimen.date_collected ? toDateInputValue(specimen.date_collected) : "",
					habitat: specimen.habitat,
					habit: specimen.habit,
					altitude_masl: specimen.altitude_masl ?? "",
					plant_height_m: specimen.plant_height_m ?? "",
					dbh_cm: specimen.dbh_cm ?? "",
					phenophase: specimen.phenophase ?? "",
